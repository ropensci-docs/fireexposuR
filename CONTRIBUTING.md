# Contributing to fireexposuR

This outlines how to propose a change to fireexposuR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("heyairf/fireexposuR", fork = TRUE)`.
...
Please note that the fireexposuR project is released with a [Contributor
