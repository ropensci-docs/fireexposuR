...
> spatial data). Please go through the steps in
> [`vignette("prometheus")`](https://docs.ropensci.org/fireexposuR/articles/prometheus.md)
...
![](reference/figures/README-map_inputs-1.png)
...
![](reference/figures/README-visualize-2.png)
...
![](reference/figures/README-visualize-3.png)
